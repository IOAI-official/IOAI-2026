...
Bu waxtuw not bi agsee, dañuy weccee sa dossier `dataset/test_public/` ci lu feeñul ak
...
Dañuy doxalaat sa notebook ci data yooyu, te fichier `answers.json` bi mu génne lañuy jëfandikoo ngir joxe score bi. Waxtaani test yu ñu nëbb jóge nañu ci distribution bu méngoo ak bu `train`, kon sa score `test_public` ci sa masin dafay jox nataalu dëgg bu li ngay jot.
...
Score bi ñuy joxe ci liggéey bii mooy **pairwise ordering accuracy**. Dafay seet bépp ñaari chunks te laaj: _kan ci ñaar ñii moo wara jiitu?_ Paar bi jub na su sa prediction joxee tontu bu méngoo ak ground truth bi. Ci waxtaan bu am chunks `n`, am na $$M = n(n-1)/2$$ pairs; na `I` doon limu inversions yi — pairs yi ñu toppante wuute ak ground truth bi:
