...
Fiecare dialog conține `n`  fișiere audio denumite `chunk_0.wav`, `chunk_1.wav`, …, `chunk_{n-1}.wav`. Segmentele sunt replici individuale. Numele fișierelor corespund doar ordinii amestecate. Acestea nu indică poziția unui segment în conversația originală. Fiecare dialog are 7–20 segmente, mono, 44.1 kHz (puteți
reeșantiona).
