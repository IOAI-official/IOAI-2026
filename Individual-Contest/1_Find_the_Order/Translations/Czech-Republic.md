...
Každý dialog obsahuje `n` zvukových souborů pojmenované `chunk_0.wav`, `chunk_1.wav`, …, `chunk_{n-1}.wav`. Jednotlivé úseky jsou samostatné promluvy. Názvy souborů odpovídají pouze zamíchanému pořadí. Neudávají, kam úsek patří v původní konverzaci. Každý dialog má 7–20 úseků, mono, 44.1 kHz (můžete
...
|--------|-----------|-----------------|-----------|
| `dataset/train/` | 1,288 | ✅ zahrnuto | trénování / fine-tunningu modelu |
...
Mějte na paměti, že limit 10 minut musí zahrnovat veškeré trénování nebo fine-tunning, které provádíte během hodnocení, i inferenci na evaluační sadě.
