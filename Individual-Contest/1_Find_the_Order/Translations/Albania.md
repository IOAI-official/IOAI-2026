...
| Folder | Dialogët | `answers.json`? | Përdoreni për të |
|--------|-----------|-----------------|-----------|
...
Gjatë vlerësimit, folder-i juaj `dataset/test_public/` zëvendësohet në mënyrë transparente me
...
⚠️ **P duhet të jetë një permutacion i mirëfilltë:** gjatësi n, indeksuar nga 0,për çdo vlerë saktësisht një herë. Vlerat e përsëritura, vlerat që mungojnë ose elementet jashtë intervalit (p.sh. të indeksuara nga 1) marrin rezultat 0 për atë dialog, njësoj si një dialog që mungon nga skedari. Një skedar me format të gabuar ose që nuk është JSON refuzohet.
