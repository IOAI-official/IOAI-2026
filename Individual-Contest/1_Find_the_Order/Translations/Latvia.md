...
Vērtēšanas laikā jūsu `dataset/test_public/` mape tiek aizstāta ar
...
- **Valodas modelis:** **Qwen2.5-0.5B**, ko var izmantot vai nu zero-shot, vai fine-tuned uz dotā `train` sadalījuma.
