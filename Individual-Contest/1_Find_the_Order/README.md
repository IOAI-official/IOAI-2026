...
| | |
|---|---|
| **Run the baseline** — fetches the dataset from Hugging Face and runs the untouched baseline | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/IOAI-official/IOAI-2026/blob/main/Individual-Contest/1_Find_the_Order/code/baseline/solution.ipynb) |
| **Evaluate a solution** — replays the contest grading against the leaderboard splits | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/IOAI-official/IOAI-2026/blob/main/Individual-Contest/1_Find_the_Order/code/grading/evaluate.ipynb) |
