...
- **Baselinescore:** 0 
- **Score van het Wetenschappelijk Comité:** 96.99 

In het nationale AI-centrum in Astana analyseren twee computermodellen — Model R (een ResNet-18) en Model V (een ViT-Tiny) — foto's. Op dit moment leveren beide modellen perfect werk: ze behalen een nauwkeurigheid van 100% en zijn het over elke afzonderlijke afbeelding eens. Om te testen hoe verschillend hun slimme „breinen” werkelijk zijn, geeft de hoofdwetenschapper je een uitdaging: breng in elke foto kleine, vrijwel onzichtbare pixelwijzigingen aan, zodat Model R en Model V het volledig met elkaar oneens zijn.
