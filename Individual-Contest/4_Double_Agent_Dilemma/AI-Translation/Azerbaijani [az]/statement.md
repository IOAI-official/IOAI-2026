...
Çıxış formatı ilə bağlı hər hansı problem olarsa, nötbuk sizi xəbərdar edəcək.
...
- **Çevirmə konveyeri (qiymətləndirmədə tətbiq olunur):** `Resize(256) → CenterCrop(224) →
  Normalize(mean=[0.485,0.456,0.406], std=[0.229,0.224,0.225])`. See Section 3 of `baseline.ipynb` təfərrüatlar üçün. 
...
- **Çıxış formatı:** Yalnız `.pt` faylları — PNG/JPG yox. Tensorlar xam şəkilə əlavə olunur və piksel dəyərləri ilkin emaldan əvvəl `[0, 1]` aralığına kəsilir.
