...
Vērtēšanas laikā jūsu `dataset/test_public/` mape tiek nepamanāmi aizstāta ar divām slēptām attēlu kopām (`test_leaderboard_a` un `test_leaderboard_b`) oficiālajai vērtēšanai. Katrā no tām ir **100 attēli** PNG formātā un etiķešu (labels) fails. 
