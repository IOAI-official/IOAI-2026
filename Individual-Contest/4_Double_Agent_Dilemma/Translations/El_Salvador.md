...
PF es una función diseñada para penalizar las perturbaciones con una norma alta y para ser muy sensible cerca del límite máximo de rendimiento. Esta está acotada en el intervalo de 0.5 a 1. La implementación completa puede consultarse en la Sección  8 de `solution.ipynb`. 
