...
- **Baseline score:** 0 
- **Scientific Committee score:** 96.99 
...
- **Output format:** `.pt` files only — no PNG/JPG . Tensors are added to the raw image and pixel values are clipped to `[0, 1]` before preprocessing.
