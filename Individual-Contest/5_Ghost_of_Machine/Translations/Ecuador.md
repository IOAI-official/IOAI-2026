...
```
dataset/train/data.jsonl      # un objeto JSON por línea: {"id": "...", "text": "..."}
dataset/train/answers.jsonl   # {"id": "...", "boundary_char_index": 1842}
dataset/test_public/data.jsonl       # {"id": "...", "text": "..."}
dataset/test_public/answers.jsonl    # únicamente en la copia de desarrollo - INEXISTENTE en el conjunto de evaluación
```
...
```json
{"id": "ejemplo_000123", "boundary_char_index": 1790}
{"id": "ejemplo_000124", "boundary_char_index": 2450}
```
