...
```
dataset/train/data.jsonl      # un objeto JSON por fila: {"id": "...", "text": "..."}
dataset/train/answers.jsonl   # {"id": "...", "boundary_char_index": 1842}
dataset/test_public/data.jsonl       # {"id": "...", "text": "..."}
dataset/test_public/answers.jsonl    # solo copia de desarrollo — NO DISPONIBLE en el conjunto oculto de test
```
