...
Cada muestra es una cadena única `text`. Hay exactamente un límite. Todo
...
- El **`boundary_char_index`** es el indice del **primer caracter de la Parte B:**
  `text[boundary_char_index:]` es exactamente la parte de la maquina y
  `text[:boundary_char_index]` es la parte humana junto con el espacio que separa las dos.
