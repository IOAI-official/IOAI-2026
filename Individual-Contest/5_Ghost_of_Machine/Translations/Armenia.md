...
- Դասական / վիճակագրական գործիքներն անսահմանափակ են․ դուք կարող եք կառուցել ցանկացած հատկանիշների վրա հիմնված (feature-based) մոդել (օրինակ՝ scikit-learn դասակարգիչներ կամ ռեգրեսորներ) ձեր իսկ հաշվարկած embedding հատկանիշների վրա։ *Նախավարժեցված խորը ուսուցման (deep-learning) կշիռները* սահմանափակված են միայն վերը նշված ցանկով։
