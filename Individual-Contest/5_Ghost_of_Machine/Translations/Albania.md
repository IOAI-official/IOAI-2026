...
Gjëra të çuditshme po ndodhin në Arkivën Kombëtare të Kazakistanit. Bibliotekarët thonë se disa libra dikur përfundonin ndryshe, por askush nuk mund ta vërtetojë — çdo kopje është e njëjtë dhe çdo histori ende ka kuptim. Jeni ftuar si studiues i AI-it për të gjetur ndryshimet.
![Fantazma](../ghost.jpg)
...
Ju merrni **dy folder-a**:

| Folder | Mostrat| `answers.jsonl`? | Përdoreni për të |
|--------|---------|------------------|-----------|
...
- **Mjedisi:** një GPU (≈16 GB VRAM), pa internet në kohën e vlerësimit — modeli i lejuar
  . **Koha reale: 10 minuta** për të gjithë
