...
የቀረበው `solution.ipynb` ቀላል ማጣቀሻ ነው፦ ከ`dataset/train/` አንድ
“አማካይ የboundary መጠን” ይገምታል፣ እና ለእያንዳንዱ test passage ያንኑ የርዝመት መጠን
ይገምታል። በተደበቀው **test_leaderboard_a** split ላይ **28.6** ነጥብ ያገኛል፣ እና
የread-`dataset/test_public/` → write-`answers.jsonl` loop ሊሠራ የሚችል template ሆኖ ብቻ ይገኛል።

በተመሳሳይ split እና በተመሳሳይ
10-minute ገደብ የተለካው **የሳይንሳዊ ኮሚቴ ነጥብ 93.41**፣ የተፈቀደውን encoder በ`train` ላይ fine-tune በማድረግ እና
መቀየሪያውን በsentences ላይ እንደ changepoint በመፈለግ የተገኘ ነው። ይህ ከፍተኛ ገደብ አይደለም — በዚህ
metric ላይ ከፍተኛው 100 ነው።
