...
The **data is not in this repository**. It exists as a private Hugging Face dataset (`IOAI-official/ioai-2026-ghost-of-the-machine`) and is not publicly accessible.
