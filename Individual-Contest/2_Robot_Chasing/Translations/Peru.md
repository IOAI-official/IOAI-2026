...
La imagen solo tiene los dos canales mencionados. La dirección del robot se proporciona una vez, en el campo de nivel superior `direction`; no está duplicada dentro de `image`.
...
familia de tareas. El conjunto de prueba público contiene 600 filas por robot. Haga un Wrap de `image` con
