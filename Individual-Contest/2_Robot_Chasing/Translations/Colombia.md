...
Cada robot recibe una instrucción en inglés que describe una tarea. Una fotografía puede tomarse en cualquier momento mientras el robot la está llevando a cabo. El objetivo es predecir la siguiente acción del robot.
...
| Carpeta | Archivos | ¿`labels.json`? | Utilícela para |
|---|---:|---|---|
