...
ci-dessus. `labels.json` est une liste JSON d'actions (`0`–`5`) associées.
...
Le score est l'**accuracy moyenne par robot** sur une échelle de `0`–`100`. L'accuracy est d'abord
