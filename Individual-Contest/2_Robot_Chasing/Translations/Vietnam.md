...
| `mission` | chỉ dẫn ba(`ng ngôn ngữ tự nhiên (nhìn thấy được) |
...
Ảnh chỉ có hai kênh  (2 chieu tho^ng tin cua array, khong phai color channel) nêu trên. Hướng của robot được cung cấp một lần trong trường `direction` cấp cao nhất (ddu+o+.c cung ca^'p trong metadata ddau tien); hướng này không được lặp lại bên trong `image`.
