...
Kustības darbība vispirms pagriež robotu uz šo absolūto virzienu un pēc tam mēģina to pārvietot par vienu šūnu. Siena vai objekts var bloķēt kustību, bet virziens tomēr mainās. `pick up` un `drop` darbojas tikai ar blakus esošo mērķa šūnu, ko nosaka direction (piem., ja direction=0, tā darbojas ar (row - 1, col)).
