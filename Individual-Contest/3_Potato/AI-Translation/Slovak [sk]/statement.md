...
- **Prostredie:** jedno GPU (≈16 GB VRAM), bez internetu
...
V každom ťahu rozhodca porovná dve slová a oznámi, ktoré z nich je sémanticky bližšie
k skrytému slovu. Každá hra sa začína
pevne stanovenou dvojicou `lamp vs potato`, pretože sú to dve z obľúbených vecí vášho priateľa. Váš program potom
...
Limit 10 minút predstavuje jeden spoločný rozpočet zahŕňajúci spustenie, prípravu a všetkých 120
hier v testovacej množine. 
...
6. Zadajte správu commitu a kliknite na Commit.
7. Kliknutím na oblak so šípkou nahor vykonajte push.
8. Vráťte sa na túto stránku súťaže a kliknite na Submit, pričom správa commitu musí zodpovedať tej, ktorú ste uviedli.
