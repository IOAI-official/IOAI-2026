...
se nerozlišují velká a malá písmena. Každé slovo, které navrhnete, musí být v `dataset/vocabulary.json`.
...
- `dataset/public_embeddings.npy` — `float32`, tvar `(1602, 2560)`. Řádek `i`
  ...
  rozhodčí používá jinou, soukromou reprezentaci.
...
Limit 10-minute je jediný společný rozpočet zahrnující spuštění, přípravu a všech 120
...
7. Kliknutím na ikonu cloudu se šipkou nahoru proveďte push.
