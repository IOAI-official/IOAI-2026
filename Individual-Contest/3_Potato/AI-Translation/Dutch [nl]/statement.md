...
Je vriend stelt voor een raadspel te spelen.
Hij kiest als jury één verborgen woord uit een vaste woordenschat, en jij moet dit binnen ten hoogste 30 beurten vinden.
In elke beurt vergelijkt de jury twee woorden en meldt welk woord semantisch dichter bij
...
geen onderscheid gemaakt tussen hoofdletters en kleine letters. Elk woord dat je voorstelt, moet in `dataset/vocabulary.json` staan.
...
de jury via stdin/stdout zoals hierboven beschreven.
...
2. Controleer dit desgewenst lokaal: `python local_test.py solution.ipynb --limit 5`.
