...
compte de la casse. Chaque mot que vous proposez doit appartenir à `dataset/vocabulary.json`.
...
2. Facultativement, vérifiez-le localement : `python local_test.py solution.ipynb --limit 5`.
   Le juge local utilise les plongements *publics*, son score a lui n'est donc
   qu'indicatif.
