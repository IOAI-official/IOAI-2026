...
Ai, në rolin e gjykatësit, zgjedh një fjalë të fshehtë nga një fjalor i fiksuar dhe ju duhet ta gjeni atë në jo më shumë se 30 raunde.
...
Ju mund ta ndryshoni klasën PublicEmbeddingPlayer. Programi juaj inicializohet një herë dhe i luan të gjitha lojërat në një ekzekutim të vetëm;
...
Një shembull i punuar, ku fjala e fshehtë tregohet vetëm për të shpjeguar protokollin:
...
Libraritë e disponueshme: `numpy`, `torch`, `sentence-transformers`. Pa internet, pa
shkarkime, pa paketa të tjera.

## Output

Asnjë. Kjo është një detyrë interaktive: zgjidhja juaj nuk shkruan file përgjigjeje; ajo komunikon me
...
1. Hapni `solution.ipynb`, editoni `PublicEmbeddingPlayer` dhe ekzekutoni të gjitha qelizat për t'u siguruar se funksionon.
...
4. Hapni Git tab në shiritin anësor të majtë të JupyterLab.
5. Kryeni **Stage** për  `solution.ipynb` (ikona **+** pranë tij).
6. Shkruani një mesazh commit-i dhe klikoni Commit.
7. Klikoni renë me shigjetë lart për të kryer push.
8. Kthehuni në këtë faqe të Garës dhe klikoni Submit, me mesazhin e commit-it që përputhet me atë që keni dhënë.

Dorëzoni saktësisht një file, me emrin `solution.ipynb`, që përfshin çdo përgatitje dhe inferencë të nevojshme.
