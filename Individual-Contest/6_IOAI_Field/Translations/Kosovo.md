...
Kryetari i Bashkisë së Astanës dëshiron ta dekorojë qytetin me logo të stilizuara të IOAI. Si statisticien, ai sheh gjithçka—duke përfshirë logon—si një funksion hapësinor $F(x, y, \overline{W})$, ku $x, y \in [0, 1]$ përfaqësojnë koordinatat në një rrafsh 2D dhe $\overline{W}$ është një bashkësi parametrash të fshehur që përcaktojnë atribute stilistike, si ngjyrat dhe këndet e shkronjave.

Meqenëse $F$ është tepër kompleks për t'u shprehur si një ekuacion matematikor i drejtpërdrejtë, detyra juaj është të trajnoni një neural network për ta përafruar atë. Rrjeti do të prodhojë një vlerë të **fushës IOAI** për çdo çift koordinatash $(x, y)$, duke gjeneruar një vizualizim të plotë me heatmap të logos në të gjithë rrafshin. Ja një shembull i vizualizimit me heatmap të $F$ me disa parametra specifikë të fshehur $\overline{W}$.
...
Për secilin rajon, pikët minimale janë 0 dhe pikët maksimale janë 1. Pikët përfundimtare janë mesatarja e pikëve në pesë rajonet (katër për secilën shkronjë dhe sfondin), e shumëzuar me 100. Ekziston një **penalizim për parametrat:**
...
3. Sigurohuni që qeliza juaj e fundit ta ruajë modelin në skedar `model.pt`.
4. Në Git tab të JupyterLab, bëni stage, comment dhe commit për `solution.ipynb` dhe `custom_model.py`, pastaj bëni push.
5. Kthehuni te faqja e Contest dhe klikoni **Submit**. Komenti i Submit duhet të jetë i njëjtë me komentin nga hapi i mëparshëm.
