...
IOAI heeft Astana overgenomen. Het oude logo vond men "niet modern genoeg", dus proberen ze wat anders: Wiskunde. Het logo is een 2D functie $F(x, y)$, waarbij de output de kleur aangeeft. Maar ze willen het logo ook trainen. Dus, ze hebben het legendarische idee om er verborgen parameters in te stoppen ($\overline{W}$). Deze definieren stilistische kenmerken zoals letterkleuren en hoeken definiëren.
