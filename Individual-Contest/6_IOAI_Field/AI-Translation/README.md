# AI translations — IOAI Field (Day 2)
...
### Flagged during generation

These specific languages did not pass the automated checks cleanly and deserve extra scepticism:

- **Arabic** — flagged `WARN` by the automated checker
- **Japanese** — flagged `WARN` by the automated checker
- **Korean** — flagged `WARN` by the automated checker
