...
- **Pontuação do Comitê Científico:** 63.53
...
4. Na aba Git do JupyterLab, prepare, comente e faça commit de `solution.ipynb` e `custom_model.py` e, em seguida, faça push.
